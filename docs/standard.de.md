...
- Das eingebundene Whiteboard fordert den Core-Komponentenfenstervertrag `borderless` und eine rahmenlose Darstellung an und entfernt anschließend innere Composer-Abstände von Panel, Abschnitt und Widget, damit die Zeichenfläche den verfügbaren Bühnenbereich nutzt.

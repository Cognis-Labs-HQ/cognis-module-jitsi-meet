...
Cognis verwaltet die temporäre Komponentenbühne und deren Bereinigung. Jitsi verändert weder das Messages-DOM noch ruft es selbst den Komponenten-Seiten-Broker auf. VoIP-Verbraucher können einen Betreff angeben; andernfalls verwendet der Anbieter den lokalisierten Betreff „VoIP-Anruf“. Komponentenanrufe enthalten keinen moduleigenen Zurück-Button und verwenden den privaten Messages-Chat weiter, aus dem sie gestartet wurden, anstatt einen Meeting-Chat zu erstellen oder zu löschen. Sie erscheinen weder in der Liste aktiver noch früherer Meetings auf der Meetings-Seite und können weder geteilt noch um Teilnehmende erweitert werden.

...
- Die optionale Whiteboard-Integration erscheint nur, wenn `whiteboard:uiGateway`, Komponentenfenster- und Floating-Window-Fähigkeiten verfügbar sind. Nur teilnehmerlose Besprechungen verwenden eine verwerfbare Arbeitsfläche. Besprechungen mit eingeladenen Teilnehmern verwenden eine dauerhafte Ressourcen-Arbeitsfläche, speichern deren Zuordnung für alle Teilnehmer und öffnen die zugeordnete Arbeitsfläche beim Laden der Besprechung automatisch.

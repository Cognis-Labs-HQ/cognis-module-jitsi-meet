...
Serverseitige Whiteboard-Prüfung, Mitgliedschaft und Löschung werden dynamisch aus der lebenszyklusgebundenen Registry `ctx.capabilities` aufgelöst. Dies entspricht dem Registrierungsvertrag des Providers und ermöglicht Jitsi, nach seinem eigenen Bootstrap beigesteuerte Capabilities zu erkennen, ohne Whiteboard für die Jitsi-Aktivierung vorauszusetzen.

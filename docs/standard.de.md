...
- Meetings deklariert die Core-Stile für Page Builder und wiederverwendbare Seitenabschnitte vor seinem Modul-Stylesheet und importiert das Host-Hilfsprogramm `ensurePageStylesheet` für optionale Anbieter-Stile. Core verwaltet nun wiederverwendbare Schaltflächenfarben, Animationen, Komponentenbühnenzustand und Stylesheet-Deduplizierung; das Modul-CSS beschränkt sich auf die Jitsi-spezifische Geometrie und deaktivierte Interaktion des Ankers.

...
Serverseitige Whiteboard-Prüfung, Mitgliedschaft und Löschung verwenden die öffentlichen Leaf-Capabilities, die Nextcloud Whiteboard über den Modulkontext veröffentlicht. Jitsi greift weder auf die private API-Fassade des Providers zu noch verwaltet es einen parallelen Capability-Resolver; Whiteboard bleibt für die Jitsi-Aktivierung optional. Bei der Kontolöschung wird die kanonische Cognis-Konto-ID vor der Aktualisierung gespeicherter Teilnehmerlisten in den aktuellen Profil-Handle aufgelöst.

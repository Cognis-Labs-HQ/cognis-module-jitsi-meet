...
- Das Bild-in-Bild des Meetings übergibt Bewegung, Größenänderung, Begrenzung auf den Ansichtsbereich und Abbau an die Host-Fähigkeit `ui:makeFloatingWindow`.

...
- Explicit `auth:requireAuth` and `ui:profileAvatarRenderer` runtime requirements so Cognis loads authentication and avatar providers before the meeting page

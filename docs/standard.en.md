...
- The spawned Whiteboard requests the core component-window `borderless` contract and frameless rendering, then removes inner composer panel, section, and widget insets so the canvas uses the available stage area.

...
- Kata sandi dibuat per rekaman rapat. Nama tampilan rapat berupa frasa lima kata yang unik tanpa awalan produk; nama yang sama mengidentifikasi Papan Tulis dan chat Messages tanpa tanggal. Rapat sekali pakai tanpa peserta tidak membuat chat Messages, dan chat lama yang terkait akan dihapus permanen saat rapat berakhir.

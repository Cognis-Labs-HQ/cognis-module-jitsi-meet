...
- Papan Tulis yang dibuka meminta tampilan tanpa bingkai dan menghapus inset ruang kerja, panel, bagian, serta widget composer di dalam jendela komponen milik rapat agar kanvas memakai area panggung yang tersedia.
- Broker halaman komponen Cognis secara otomatis mengelola gambar-dalam-gambar rapat saat Papan Tulis menempati panggung; modul ini tidak mengimplementasikan perilaku jendela mengambang.

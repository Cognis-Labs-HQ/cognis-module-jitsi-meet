...
- Papan Tulis yang dibuka meminta kontrak jendela komponen inti `borderless` dan tampilan tanpa bingkai, lalu menghapus inset panel, bagian, serta widget composer bagian dalam agar kanvas memakai area panggung yang tersedia.

...
Persyaratan kapabilitas server secara eksplisit mencakup `whiteboard:fetchBoardData`, `whiteboard:membership`, dan `whiteboard:deleteCanvas`. Cognis kemudian memvalidasi dan mengurutkan penyedia Whiteboard yang aktif sebelum Jitsi menangani sinkronisasi status, alih-alih membiarkan tombol mencapai rute yang konteks terbatasnya tidak dapat menyelesaikan penyedia.

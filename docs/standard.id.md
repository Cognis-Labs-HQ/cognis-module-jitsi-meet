...
- Meetings mendeklarasikan gaya page-builder inti dan bagian halaman yang dapat digunakan ulang sebelum stylesheet modulnya serta mengimpor utilitas host `ensurePageStylesheet` untuk gaya penyedia opsional. Core kini memiliki warna tombol, animasi, status stage komponen, dan deduplikasi stylesheet yang dapat digunakan ulang; CSS modul dibatasi pada geometri khusus Jitsi dan interaksi nonaktif pada tautan.

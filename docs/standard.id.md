...
Verifikasi, keanggotaan, dan penghapusan Whiteboard di sisi server menggunakan kapabilitas publik spesifik yang diterbitkan Nextcloud Whiteboard melalui konteks modul. Jitsi tidak mengakses fasad API privat milik penyedia atau mempertahankan penyelesai kapabilitas paralel; Whiteboard tetap opsional saat Jitsi diaktifkan. Pembersihan saat akun dihapus menyelesaikan ID akun kanonis Cognis menjadi handle profil saat ini sebelum memperbarui daftar peserta tersimpan.

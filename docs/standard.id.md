...
Verifikasi, keanggotaan, dan penghapusan Whiteboard di sisi server diselesaikan secara dinamis melalui kedua permukaan akses kapabilitas publik yang tercakup dalam siklus hidup: registry `ctx.capabilities` yang digunakan penyedia saat ini dan pengakses konteks modul untuk kapabilitas publik. Ini mencerminkan kontrak pendaftaran Nextcloud Whiteboard dan mempertahankan Whiteboard sebagai integrasi opsional saat Jitsi diaktifkan.

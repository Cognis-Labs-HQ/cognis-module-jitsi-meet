...
Verifikasi, keanggotaan, dan penghapusan Whiteboard di sisi server diselesaikan secara dinamis dari registry `ctx.capabilities` yang tercakup dalam siklus hidup. Hal ini sesuai dengan kontrak pendaftaran penyedia dan memungkinkan Jitsi melihat kapabilitas yang dikontribusikan setelah bootstrap-nya sendiri tanpa menjadikan Whiteboard sebagai syarat pengaktifan Jitsi.

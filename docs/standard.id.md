...
- Integrasi Papan Tulis opsional hanya muncul ketika kapabilitas `whiteboard:uiGateway`, halaman komponen, dan jendela mengambang tersedia. Hanya rapat tanpa peserta yang memakai kanvas sekali pakai. Rapat dengan peserta undangan memakai kanvas sumber daya persisten, menyimpan pemetaannya untuk setiap peserta, dan membuka kanvas yang dipetakan secara otomatis saat rapat dimuat.

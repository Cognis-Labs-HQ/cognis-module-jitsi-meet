...
- URL entry SPA Meetings menyertakan versi modul agar browser tidak memakai kembali modul entry yang tidak dapat diubah dari rilis sebelumnya setelah impor diganti nama. Utilitas browser dan seluruh katalog stylesheet umum dimuat melalui kapabilitas wajib `ui:reuse` sebelum permukaan Meetings dirender. Cognis core menyediakan tampilan kontrol standar, sedangkan CSS modul hanya memiliki tata letak khusus Jitsi.

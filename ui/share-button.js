  ...
  try {
    await openShareLinksPopup({
      ...
      labels: {
        ...
        shareOptions: i18n.t('module.jitsi_meet.share.share_options_label'),
        mail: i18n.t('ui.reuse.mail'),
        emailRecipients: i18n.t('module.jitsi_meet.share.email_recipients'),
        label: i18n.t('module.jitsi_meet.share.label'),
        labelPlaceholder: i18n.t('module.jitsi_meet.share.label_placeholder'),
        expiryLabel: i18n.t('module.jitsi_meet.share.expiry_label'),
        password: i18n.t('module.jitsi_meet.share.password_optional'),
        passwordPopupTitle: i18n.t('module.jitsi_meet.share.password_title'),
        ...
        expiresAtLabel: i18n.t('module.jitsi_meet.share.expires_at_label'),
        expiredAtLabel: i18n.t('module.jitsi_meet.share.expired_at_label'),
        ...
        deleteConfirmMessage: i18n.t('module.jitsi_meet.share.delete_prompt'),
...
export async function bindShareButton({
  ...
  try {
    shareButtonModule = await import(
      '/static/gateways/share/ui/reuse/share-button.js'
    );
  } catch (error) {
    console.error('[jitsi-meet] failed to load the Share button capability', {

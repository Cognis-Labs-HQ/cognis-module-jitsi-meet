...
## PiP へ移るまでコンポーネント通話を保護

破棄可能な通話は元のコンポーネントウィンドウ内で、アンロード、リンク、履歴ナビゲーションの保護を維持します。ホスト管理のナビゲーションは、コンポーネントが実際にフローティング PiP ウィンドウ内にある間だけ許可します。破棄可能なミーティングでは、すべてのミーティング通知も抑制します。

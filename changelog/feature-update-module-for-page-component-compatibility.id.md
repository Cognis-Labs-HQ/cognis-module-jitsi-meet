...
Nama tampilan rapat kini menggunakan kapabilitas host `reuse:generatePassphrase` untuk membuat frasa sandi empat kata yang aman secara kriptografis tanpa bergantung pada paket lokal modul yang tidak diterapkan. Penangkapan pengenal ruang Jitsi yang terpisah tidak lagi mengganti nama yang terlihat oleh pengguna tersebut.
